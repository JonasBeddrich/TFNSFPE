...
#if defined(alpha_01)
    const std::string tf_degree = "alpha=0.1"; 
...
#if defined(alpha_02)
    const std::string tf_degree = "alpha=0.2"; 
    std::vector<double> get_weights(){
        std::vector<double> weights(n_modes,0.); 
...
#if defined(alpha_03)
    const std::string tf_degree = "alpha=0.3"; 
    std::vector<double> get_weights(){
        std::vector<double> weights(n_modes,0.); 
...
#if defined(alpha_04)
    const std::string tf_degree = "alpha=0.4"; 
    std::vector<double> get_weights(){
        std::vector<double> weights(n_modes,0.); 
...
#if defined(alpha_06)
    const std::string tf_degree = "alpha=0.6"; 
    std::vector<double> get_weights(){
        std::vector<double> weights(n_modes,0.); 
